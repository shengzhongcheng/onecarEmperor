<template>
	<view>
		...
		<view class="userdizhi">
			<view class="ordsimg">
				<image :src="getImgsrc(yipaidan[0].image)" mode=""></image>
			</view>
			<view class="userinfor_dizi">
				<view class="ordsshopname">{{yipaidan[0].name}}</view>
				<view class="ordsshopguige">数量:{{yipaidan[0].num}}份</view>
			</view>
			<view class="ordsmoney">
				<view class="">￥<strong>{{yipaidan[0].money}}</strong></view>
			</view>
		</view>
		<!-- 商品费用 -->
		<view class="shopmoney">
			...
			<view class="shopmoneylist">
				...
				<view>{{yipaidan[0].nickname}}</view> 
			</view>
			<view class="shopmoneylist">
				<view class="shopclo">收货人</view>
				<view>{{yipaidan[0].real_name}}</view> 
			</view>
			<view class="shopmoneylist">
				<view class="shopclo">联系电话</view>
				<view>{{yipaidan[0].phone}}</view> 
			</view>
			<view class="shopmoneylist">
				<view class="shopclo">收货地址</view>
				<view >{{yipaidan[0].province}}-{{yipaidan[0].city}}-{{yipaidan[0].district}}</view> 
			</view>
		</view>
		<!-- 商品下单方式 -->
		<view class="shopmoney">
			...
			<view class="shopmoneylist">
				...
				<view>{{yipaidan[0].orderid}}</view> 
			</view>
			<view class="shopmoneylist">
				<view class="shopclo">商品总数</view>
				<view>{{yipaidan[0].num}}</view> 
			</view>
			<!-- <view class="shopmoneylist">
			...
			<view class="shopmoneylist">
				...
				<view >{{yipaidan[0].createtime}}</view> 
			</view>
			<view class="shopmoneylist">
			...
			<view class="shopmoneylist ">
				...
				<view class="blue">售后订单</view> 
			</view>
			<view class="shopmoneylist ">
				<view class="shopclo">商品总价</view>
				<view class="">{{yipaidan[0].money}}</view> 
			</view>
			<!-- <view class="shopmoneylist ">
			...
			<view class="shopmoneylist ">
				...
				<view class="">{{yipaidan[0].shifu}}</view> 
			</view>
			<view class="shopmoneylist red">
				<view class="shopclo red">退款金额</view>
				<view class="red">{{yipaidan[0].money}}</view> 
			</view>
		</view>
