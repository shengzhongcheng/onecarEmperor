	...
	<view v-show="showview">
		...
		<view class="userdizhi">
			...
			<view class="userinfor_dizi">
				<!-- <view class="dizi">{{yipaidan[0].province}}-{{yipaidan[0].city}}-{{yipaidan[0].district}}</view>
				<view class="dizicol">{{yipaidan[0].real_name}} {{yipaidan[0].phone}}</view> -->
